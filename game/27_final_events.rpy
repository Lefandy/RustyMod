label want_to_rule:
    ...
    her "Я курировала его в прошлом году и это был самый лучший бал за последние годы."
    ...
    menu:
        ...
        "\"Нет. Профессор Снейп должен быть главным!\"":
            ...
            if d_flag_01 or d_flag_02 or d_flag_03:
                ...
                her "...эгоисткой?"
                m "Твои одноклассники заслуживают самого лучшего бала в мире!"
                ...
                if d_flag_01:
                    ...
                    $ hermione_chibi_xpos = 310

                    $ h_c_u_pic = "03_hp/08_animation_02/01.png"
                    show screen h_c_u
...
label giving_thre_dress:
    ...
    m "Вот... Это тебе..."
    $ the_gift = "03_hp/18_store/01.png"
    show screen gift
    with d3
...
label good_bye_snape:
    ...
    sna "Спасибо за то, что был моим..."
    $ s_sprite = "03_hp/10_snape_main/snape_06.png"
    sna "Я, пожалуй, пойду..."
    ...
    if end.IsEnding(const_ENDING_YOUR_WHORE):
        ...
        menu:
            m "Дорогая..."
            "\"Мисс Грейнджер\"":
                $ word_01 = tr("мисс Грейнджер")
            "\"Грязная шлюха\"":
                $ word_01 = tr("грязная шлюха")
            "\"Потаскуха\"":
                $ word_01 = tr("потаскуха")
            "\"Спермоглотка\"":
                $ word_01 = tr("спермоглотка")
            "\"Человеческая самка\"":
                $ word_01 = tr("человеческая самка")
            "\"Подруга\"":
                $ word_01 = tr("подруга")
        hide screen genie
        show screen paperwork
        with Dissolve(0.3)
        $ renpy.say (m, tr("Да, \"Дорогая ") + tr(word_01) + tr("\" подходит идеально..."))
        ">чирк-чирк-чирк..."
        ">чирк-чирк-чирк..."
        ...
        menu:
            ...
            "\"на родной корабль-матку\"":
                $ word_02 = tr("на родной корабль-матку")
            "\"в Измерение \"X\"":
                $ word_02 = tr("в Измерение \"X\"")
            "\"в мой мир\"":
                $ word_02 = tr("в мой мир")
            "\"на мою родную планету - Криптон\"":
                $ word_02 = tr("на мою родную планету - Криптон")
        hide screen genie
        show screen paperwork
        with Dissolve(0.3)
        $ renpy.say (m, tr("Да, \"Пора вернуться назад ") + tr(word_02) + tr("\" пойдет..."))
        ">чирк-чирк-чирк..."
        ">чирк-чирк-чирк..."
        ...
        menu:
            m "...прощай, моя маленькая... "
            "\"Членолюбка\"":
                $ word_03 = tr("членолюбка")
            "\"Спермобаза\"":
                $ word_03 = tr("спермобаза")
            "\"Девочка\"":
                $ word_03 = tr("девочка")
            "\"Ведьма\"":
                $ word_03 = tr("ведьма")
        ...
        show screen paperwork
        with Dissolve(0.3)
        $ renpy.say (m, tr("Да, \"прощай, моя маленькая ") + tr(word_03) + tr("\" звучит в самый раз..."))
        ">чирк-чирк-чирк..."
        ">чирк-чирк-чирк..."
        show screen genie
        hide screen paperwork
        ...
        menu:
            ...
            "\"Кларк Кент\"":
                ...
                show screen paperwork
                with Dissolve(0.3)
                $ renpy.say (m, tr("Да, \"искренне твой, ") + tr(word_04) + tr("\"..."))
                show screen genie
                hide screen paperwork
                with Dissolve(0.3)
                m "..........."
        ...
        show screen paperwork
        with Dissolve(0.3)
        $ renpy.say (m, tr("Да, \"") + tr(word_04) + tr("\"..."))
        show screen genie
        hide screen paperwork
        with Dissolve(0.3)
        m "........................"
    ...
    if not persistent.game_complete:
        ...
        centered "{size=+7}{color=#cbcbcb}Поздравляем с завершением игры!{/color}{/size}\n\n {size=+5}{color=#cbcbcb}Это концовка \"03\" из \"03\".{/color}{/size}"


        centered "{size=+7}{color=#cbcbcb}Спасибо за то, что играли!{/color}{/size}\n\n {size=+5}{color=#cbcbcb}SAD CRAB 2015{/color}{/size}"
...
transform custom_walk_02(x, x2):
    xpos x
    ypos 250
    linear hermione_speed xpos x2

transform custom_walk(x, x2):
    xpos x
    ypos 210
    linear snapes_speed xpos x2
