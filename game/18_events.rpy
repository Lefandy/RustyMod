label event_00:
    ...
    $ hero("Хм...// Итак, этот высокий задумчивый парень принял меня за другого...?// Следовательно я, по всей вероятности, под действием маскирующего заклинания...",
            ".........",
            "В свою очередь я - джинн, замаскированный под человека, который, в свою очередь, замаскирован под другого человека...// Нет, все это очень глупо...", m)

    $ days_without_an_event = 0

    $ this.event_02.Finalize()
    jump day_start
...
label event_06:
    ...
    hide ch_gen
    show expression "03_hp/04_duel/no_magic.png" at Position(xpos=550, ypos=250, xanchor="center", yanchor="center")
...
label event_08_02:
    ...
    $ renpy.play('sounds/door.mp3')
    $ hermi.chibi.State("door", speed="go").Trans(d4, "blink").Trans("go center", "blink")
    pause.5
    $ screens.ShowD3("bld1")
...
label event_14:
    ...
    $ herView.hideshowQQ( "body_07.png", pos )
    her "Но это не все..."
    her "В \"ОЗМП\" мы исследуем нашу систему образования более детально..."
...
label event_15:
    ...
    menu:
        "\"Ты имеешь в виду сексуальные услуги?\"":
            ...
            m "{size=-4}(Почистить мою башню? Хех... Это, вероятно, грязная шуточка или вроде того...){/size}"
...
label event_16:
    ...
    "Мистический голос" "Может хватит?"
    ...
    g4 "{size=-4}Ну и как тут не шутить о разработчиках?{/size}"
    ...
    if zyablik_switch == 1:
        ...
        m "{size=-4}Есть чем-нибудь похмелиться..?{/size}"
        $ s_sprite = "03_hp/10_snape_main/snape_03.png"
        show screen s_head2
        sna2 "..."
        $ s_sprite = "03_hp/10_snape_main/snape_17.png"
...
label bad_reports:
    ...
    g9 "... или женщина, пишущая глупые книжки для подростков."
    hide screen snape_main                                                                                                                   
    with d3
    $ s_sprite = "03_hp/10_snape_main/snape_06.png"
    show screen snape_main                                                                                                                  
    ...
    show screen snape_main                                                                                                                  
    with d3
    sna " И почему у меня на этот счет такое плохое предчувствие..?"
    hide screen snape_main                                                                                                                   
    with d3
    $ s_sprite = "03_hp/10_snape_main/snape_06.png"
    show screen snape_main                                                                                                                  
    ...
    sna "\"...а потом он взял...\""
    sna "\"... и они...\""
    g4 "{size=+5}Овеликиепескихватит!{/size}"
