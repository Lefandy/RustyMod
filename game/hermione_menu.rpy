...
label hermione_approaching:
    ...
    menu:
        ...
        "- Дать журналистское задание -" if nsp_newspaper_menu >= 6 and daytime:
            if nsp_event_rights_1 >= 2 and nsp_event_rights_2 >=1 and nsp_event_magls_1 >= 1 and nsp_event_magls_2 >= 1 and nsp_event_kviddich_1 >= 1 and nsp_event_forest_1 >= 1 and nsp_event_studio_1 >= 1:
                call nsp_her_demo2
                jump hermione_main_menu
            if hermi.liking>=0:
        ...
        "- Купить \"сексуальный\" рейтинг -" if this.Has("her_wants_buy"):
            if hermi.liking>=0:
