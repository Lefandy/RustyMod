...
label new_request_23:

    $ current_payout = 55

    $ herView.hideQQ()
    m "{size=-4}(Попросить ее передернуть однокласснику?){/size}"
    $ menu_x = 0.5
    menu:
    ...
    if request_23_points == 0:
        if hermi.whoring <=14 or request_20_points <= 1:
        ...
        her "Я точно не успокоюсь сэр! Это за гранью приемлемого!"
        m "Хорошо, ладно, может, я и впрямь в этот раз немного переступил черту ..."
        $ herView.hideshowQQ( "body_47.png", pos )
        ...
        $ herView.hideshowQQ( "body_47.png", pos )
        her "!!!......"
        m "Ой, да брось... Всего лишь разок немного замарать ручки."
        ...
        her ".............."
        $ herView.hideshowQQ( "body_79.png", pos )
        her "Я рада, что вы одумались, сэр."
        ...
        if hermi.whoring >= 15 and hermi.whoring <= 17:
            ...
            $ herView.hideshowQQ( "body_69.png", pos )
            her "Я посмотрю, что смогу сделать..."
            m "Шикарно!"

        elif hermi.whoring >= 18 and hermi.whoring <= 20:
            ...
            m "Естественно."
            $ herView.hideshowQQ( "body_118.png", pos )
            her "Ну ладно... Я посмотрю, что смогу сделать..."
...
label new_request_23_complete:
    ...
    if hermi.whoring >= 15 and hermi.whoring <= 17:
        if one_out_of_three == 1:
            ...
            m "Я сказал вам идти и хорошенько подрочить вашему однокласснику."
            $ herView.hideshowQQ( "body_79.png", pos )
            ...
            menu:
                "\"Ну, тогда это не считается.\"":
                    ...
                    her "Что?"
                    her "Но сэр, я..."
                    m "Если ты не заставила его кончить, значит это нельзя назвать хорошей дрочкой. Точка."
                    $ herView.hideshowQQ( "body_117.png", pos )
        ...
        if one_out_of_three == 1:
            ...
            her "Я собираюсь встретиться с ним, как только закончу с Вами, сэр."
            m "Хм..."
            $ herView.hideshowQQ( "body_118.png", pos )
            ...
            menu:
                "\"Нет. Ты провалила это задание, девочка.\"":
                    ...
                    $ herView.hideshowQQ( "body_118.png", pos )
                    her "И теперь мне все равно придется дрочить ему..."
                    m "Ну, я не заставлял тебя давать это обещание, ведь так?"
                    $ herView.hideshowQQ( "body_117.png", pos )
                    her "......"
                    $ herView.hideshowQQ( "body_32.png", pos )
                    her "Это просто нечестно!"
                    $ hermi.liking -=20
                    $ request_23 = False
                    call music_block
                    jump could_not_flirt
                "\"Хорошо. Думаю, что я могу тебе доверять.\"":
                    ...
                    $ herView.hideshowQQ( "body_45.png", pos )
                    her "Спасибо, сэр."
                    her "Я была уверена, что вы поймете."
            ...
            her "Да, сэр..."
            $ herView.hideshowQQ( "body_29.png", pos )
            her "Хотя, я все еще не решила, как мне к этому относиться..."
            ...
            menu:
                ...
                "\"Да, именно так бы я тебя и описал.\"":
                    ...
                    her "Вы должны понимать, что я не получаю удовольствия от этого..."
            ...
            m "Mисс Грейнджер, вы выполнили задание?"
            show screen blktone
            with d3
            $ herView.hideshowQQ( "body_16.png", pos )
            ...
            her "Так что у меня не было времени тщательно это спланировать..."
        ...
        if one_out_of_three == 1:
            ...
            $ herView.hideshowQQ( "body_88.png", pos )
            her "..............."
            m "Давай выкладывай. Неопределенность убивает меня."
            $ herView.hideshowQQ( "body_87.png", pos )
            play music "music/(Orchestral) Playful Tension by Shadow16nh.mp3" fadein 1 fadeout 1 
            her "Я сделала это во время урока..."
            m "Впечатляюще..."
            $ herView.hideshowQQ( "body_124.png", pos )
            her "Да, я старалась вести себя как можно естественнее..."
            ...
            m "Весьма впечатляюще, мисс Грейнджер."
            $ herView.hideshowQQ( "body_128.png", pos )
            her "Спасибо, сэр."
            m "Ты же не ждешь, что я увеличу твою плату в несколько раз, ведь так?"
            $ herView.hideshowQQ( "body_188.png", pos )
            her "Конечно нет, сэр."
