...
label new_request_04:
    ...
    if hermi.whoring <=2:
    ...
    elif hermi.whoring >= 3 and hermi.whoring <= 5:
        ...
        menu:
            ...
            "\"Я хочу потискать твои грудки.\"":
                ...
                ">Вы притягиваете ее за талию и хватаетесь рукой за грудь..."
                "- Просто протягиваете руку и хватаетесь. -"
                ">Затем протягиваете вторую и руку и вот уже держите обе сиськи!"
        ...
        ">Гермиона пытается оттолкнуть вас, но вы крепко держите ее..."
        ...
        ">Вы сжимаете ее сиськи словно тисками."
        $ her_head_state = 10
        her_head_main "Профессор, вы делаете мне больно!"
        g4 "Просто стой на месте, девочка!"
        $ her_head_state = 11
        her_head_main "Н-но..."
        m "Я просто хочу немного потискать твою грудь, а ты получишь очки!"
        $ her_head_state = 12
        ...
        menu:
            ...
            "- Массировать грудь -":
                ...
                ">Вы слегка щиплите одну из грудок..."
                $ her_head_state = 13
                her_head_main "Профессор... Вы ущипнули меня?.."
    ...
    if hermi.whoring >= 6:
        ...
        pause.5
        play music "music/(Orchestral) Playful Tension by Shadow16nh.mp3" fadein 1 fadeout 1 
        if this.new_request_12.IsFinished():
            ">Гермиона начинает стягивать свою униформу..."
            m "Нет, не стоит. Я хочу, чтобы ты была полностью одета..."
        ...
        menu:
            "\"Тебе нравится это, девочка?\"":
                ...
                $ her_head_state = 1
                her_head_main "Небольшая цена за честь моего факультета......{image=textheart.png}"
