...
label new_request_29:
    ...
    if IsFirstRun():
        ...
        her "Конечно, я буду возражать, сэр!"
        ...
        her "!!!!!!!!!!!!!!!"
        $ herViewHead.hideQ()
        m "Расслабься, девочка. Я только снимаю твои трусики."
        ...
        her "Вы порвете меня на части, сэр!"
        $ herViewHead.hideQ()
        ...
        menu:
            "\"Тебе должно быть стыдно за себя!\"":
                ...
                her "А-а-а..."
                her "Мои однокурсники рассчитывают на меня... а-а..."
                $ herViewHead.hideQ()
        ...
        show screen sex_plus1
        pause
        hide screen sex_plus1
        $ herViewHead.hideQ()
        ...
        menu:
            "- Обкончать Гермиону -":
                ...
                $ herViewHead.showQ( "body_133.png", posHead )
                if daytime:
                    her "думаю, мне пора вернуться в класс..."
                else:
                    her2 "думаю, мне пора вернуться в спальню..."
                $ herViewHead.hideQ()
                m "Хорошо."
    ...
    elif IsRunNumberOrMore(3):

        m "Мисс Грейнджер..."
        m "Прошлой ночью мне приснилось..."
        ...
        menu:
            ...
            "\"Быть жестким с ней!\"":
                ...
                show screen blktone
                with d3
                ">Вы продолжаете увеличивать темп."
                $ g_c_u_pic = "sex2_ani"
                ">Комнату наполняет звук шлёпанья и стонов..."
                hide screen blktone
                with d3
        ...
        if not daytime:
            ...
            hide screen candlefire_02
        with d3
        ">Вы начали трахать Гермиону ещё сильнее и жестче!"
        hide screen blktone 
        with d3
        $ herViewHead.showQ( "body_139.png", posHead )
        ...
        $ herViewHead.hideQ()
        m "Заткнись, шлюха!"
        show screen sex_plus2
        pause
        hide screen sex_plus2
        g4 "Ах"
        menu:
            "- Кончить в Гермиону -":
                with hpunch
