...
label new_request_10:
    ...
    $ herView.hideQQ()
    m "{size=-4}(Сказать ей, чтобы одноклассник облапал её?){/size}"
    $ menu_x = 0.5
    menu:
        "\"(Да, давай попробуем!)\"":
            pass
    ...
    if request_10_points == 0:
        ...
        m "Конечно, я понимаю. Мне не обязательно знать подробности..."
        ...
        if hermi.whoring <=5 or request_02_c_points <= 1:
            jump too_much
        $ herView.hideshowQQ( "body_31.png", pos )
        ...
        her "Извините, сэр?"
        m "*Кхем!* Я имею ввиду, ответственные и заботливые!"
        m "Ну, как бы то ни было... Вот ваше задание на сегодня, мисс Грейнджер."
        m "Найти себе мальчика и уговорить его поласкать вас..."
        ...
        her "Я, наверное, пойду. Скоро начнутся уроки..."
        $ herView.hideQ()
    else:
    ...
    menu:
        ...
        "\"Расскажи подробнее\"":
            ...
            if hermi.whoring >= 6 and hermi.whoring <= 8:
                ...
                her "Ну... Эм..."
                m "Говори, девочка."
                m "Ты дала себя потрогать какому-нибудь счастливчику?"

                if one_out_of_three == 1:
                    her "Да, дала, сэр..."
                    m "Ну же? Расскажи."
                    her "Ну, вообще-то, особо нечего рассказывать..."
                    $ herView.hideshowQQ( "body_31.png", pos )
                    ...
                    m "Это всё, что ты можешь сказать?.."
                    ...
                    $ herView.hideshowQQ( "body_31.png", pos )
                    play music "music/(Orchestral) Playful Tension by Shadow16nh.mp3" fadein 1 fadeout 1 
                    her "Я привела одного парня из \"Пуффендуя\" в пустую комнату и предложила ему потрогать меня, если он захочет."
                    her "И..."
                    $ herView.hideshowQQ( "body_29.png", pos )
                    her "..........."
                    m "И?"
                    ...
                    m "Извините, что рассказываю вам об этом..."
                    $ herView.hideshowQQ( "body_21.png", pos )
                    her "Это было просто ужасно, сэр..."
                    m "Ладно тебе, ладно..."
                    $ herView.hideshowQQ( "body_23.png", pos )
                    her "*Хнык!*"
                    m "Если я накину 10 дополнительных очков, тебе будет легче?"
                ...
                if one_out_of_three == 1:
                    ...
                    $ herView.hideshowQQ( "body_16.png", pos )
                    her "Ну..."
                    her "Я не уверена, что вы хотите это услышать, но..."
                    her "Во время того, как нас учили собирать траву..."
                    $ herView.hideshowQQ( "body_44.png", pos )
                    her "Я дала одному парну дотронуться до себя под юбкой..."
                    her "И пока профессор Стебель объясняла разницу между \"мандрейк\" и \"мандрагора\"..."
                    $ herView.hideshowQQ( "body_08.png", pos )
                    her "Конечно, кое-что я уже знала..."
                    $ herView.hideshowQQ( "body_44.png", pos )
                    her "Я дала потрогать своему напарнику по лабораторным мою попу..."
                    her "Ну, вот и всё..."
                    m "Хм..."
                    menu:
                        "\"Ты могла бы и постараться, чтобы выполнить задание как следует.\"":
                            $ herView.hideQQ()
                    ...
                    her "................."
                    her "Ладно..."
                    her "Я подошла к парню, который всегда мне нравился..."
                    her "Нашла в себе силы попросить его идти за мной..."
                    $ herView.hideshowQQ( "body_31.png", pos )
                    her "Раньше я бы даже не подошла к нему..."
                    her "Но помня о важности задания, я каким-то образом собрала свою волю в кулак..."
                    her "Это придало мне смелости..."
                    m "Рад помочь, Мисс Грейнджер."
                    $ herView.hideshowQQ( "body_87.png", pos )
                    her "Я завела его в библиотеку..."
                    her "Мы нашли тихое местечко между книжными шкафами..."
                    her "И я сказала ему, что он может трогать меня, где пожелает..."
                    her "И...."
                    ...
                    her "Я даже забыла там свою обувь, и через пару часов пришлось возвращаться..."
                ...
                if one_out_of_three == 1:
                    ...
                    her "И передала её моему напарнику по лабораторным работам, и затем..."
                    $ herView.hideshowQQ( "body_69.png", pos )
                    play music "music/Chipper Doodle v2.mp3" fadein 1 fadeout 1 
                    her "Профессор Снейп вытащил её из моей руки..."
                    $ herView.hideshowQQ( "body_79.png", pos )
                    her "Он прочитал её вслух перед всем классом..."
                    ...
                    her "У меня даже закружилась голова..."
                    $ herView.hideshowQQ( "body_128.png", pos )
                ...
                if one_out_of_three == 2:
                    ...
                    her "сегодня произошло кое-что необычное, сэр..."
                    ...
                    $ herView.hideshowQQ( "body_128.png", pos )
                    her "Раньше я бы даже внимания не обратила..."
                    her "Но в этот раз решила не упускать возможность..."
                ...
                if one_out_of_three == 3:
                    ...
                    $ herView.hideshowQQ( "body_78.png", pos )
                    her "Но, в некотором роде, это перешло в кое-что другое..."
                    play music "music/(Orchestral) Playful Tension by Shadow16nh.mp3" fadein 1 fadeout 1 
                    m "Хм?"
                    $ herView.hideshowQQ( "body_44.png", pos )
                    her "Хм..."
                    her "Ну, в общем... меня поймали, когда я давала трогать свою грудь одному мальчику..."
                    ...
                    m "Абсолютно..."
                    m "Вот, что значит настоящая любовь - она {size=+5} должна {/size} выдержать любые испытания."
                    ...
                    her "Я почувствовала себя лишней и решила тихо удалиться......"
                    m "Ясно..."
