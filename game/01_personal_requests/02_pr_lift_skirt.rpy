...
label new_request_02:
    ...
    if hermi.whoring <= 2:
        ...
        show screen hermione_lift_skirt_normal 
        with d3
    elif hermi.whoring >=6 and hermi.whoring<13:
                        ...
                        menu:
                            ...
                            "- Продолжать смотреть ей в глаза -":
                                ...
                                if not end.IsEnding(const_ENDING_STRONG_GIRL) and hermi.whoring<14:
                                    ...
                                    $ renpy.say (her, tr("Сэр, мне уже нужно идти. Может, я вас по-быстрому подою и уйду заниматься?"))
                                    menu:
