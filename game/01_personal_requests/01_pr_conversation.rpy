...
label new_request_01:
    ...
    $ pos = POS_140
    m "Итак?"
    if IsFirstRun() and hermi.whoring <=5:
    ...
    if hermi.whoring >= 0 and  hermi.whoring <= 5:
        ...
        m "ДА!Я сказал что имя Стебль очень смешно звучит,не так ли??"
        $ herView.hideshowQQ( "body_14.png", pos )
        ...
        her "Это очень воодушевляет, когда знаешь, что поступаешь правильно!"
    ...
    elif hermi.whoring >= 6 and hermi.whoring<=11:
        ...
        her "Очень подло!"
        m "И что же вы теперь будете делать, мисс Грейнджер?Ммм?"
        ...
        if d_flag_01:
            ...
            her "Мои очки, пожалуйста. Думаю, я заслужила их."
            m "Да, даже очень."
            ...
            her "Я думаю, следует ввести систему штрафов, чтобы наказать девушек, которые жульничают..."
            m "(Все, что я слышу это - \"нужно наказать девочек\"...)"
            her "Также это поможет мальчикам, так они не будут дискриминироваться!"
            m "Мальчики?"
        ...
        menu:
            ...
            "\"C каких это пор вы стали выбирать себе задания, мисс Грейнджер?":
                ...
                her "Кстати, мы решили пойти дальше!"
                ...
                if not hermi._SCUKO_presented:
                    ...
                    $ herView.hideshowQQ( "body_12.png", pos )
                    her "Правда, с названием пока не решено..."
