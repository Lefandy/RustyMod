...
label new_request_15:
    ...
    if request_15_points == 0:
        ...
        her "?!!"
        if hermi.whoring <=8 or request_10_points <= 1:
            jump too_much
        ...
        if hermi.whoring >= 9 and hermi.whoring <= 11:
            ...
            her "Мне ведь заплатят за это, так?"
            m "Конечно."
            $ herView.hideshowQQ( "body_127.png", pos )
            her "Тогда почему я должна отказываться от такого простого задания?"
            ...
            g9 "{size=-3}(Я настолько хороший тренер, что это начинает пугать!){/size}"
...
label new_request_15_complete:
    ...
    if hermi.whoring >= 9 and hermi.whoring <= 11:
        if one_out_of_three == 1:
            ...
            m "Мисс Грейнджер, вы справились с заданием?"
            play music "music/Chipper Doodle v2.mp3" fadein 1 fadeout 1 
            $ herView.hideshowQQ( "body_29.png", pos )
            her "Эм... Вроде того..."
            m "Вроде того?"
            $ herView.hideshowQQ( "body_31.png", pos )
            her "Да... эм..."
            her "Ну, я попыталась показать их тому парню из \"Пуффендуя\"..."
            $ herView.hideshowQQ( "body_87.png", pos )
            ...
            her "Это стало привлекать внимание остальных учеников..."
            ...
            her "Простите, сэр..."
            m "Все хорошо..."
            m "Я и не ожидал, что у тебя все будет получаться идеально с самого начала твоей тренировки..."
            $ herView.hideshowQQ( "body_117.png", pos )
            her "(Моей тренировки?)"
        ...
        if one_out_of_three == 1:
            ...
            m "После того, как расскажете, чем именно вы занимались сегодня."
            $ herView.hideshowQQ( "body_33.png", pos )
            her "...................."
            $ herView.hideshowQQ( "body_31.png", pos )
            her "Я и вправду обязана рассказывать об этом, сэр?"
            m "Когда ты вот так выворачиваешься..."
            m "Ты только возбуждаешь мое любопытство. Ты же знаешь об этом, ведь так?"
            $ herView.hideshowQQ( "body_117.png", pos )
            her "Ууу..."
            $ herView.hideshowQQ( "body_118.png", pos )
            her "Нуу... Эмм..."
            ...
            her "Я не знаю, сэр..."
            her "Если честно, мои глаза были закрыты..."
            m "Тогда почему ты думаешь, что хоть кто-то тебя увидел, а?"
        ...
        if one_out_of_three == 1:
            ...
            $ herView.hideshowQQ( "body_87.png", pos )
            her "Вскоре меня стали замечать со двора..."
            ...
            m "Это не поручения, мисс Грейнджер..."
    ...
    if one_out_of_three == 2 and hermi.whoring >= 12 and hermi.whoring <= 14:
    ...
    if one_out_of_three == 3 and hermi.whoring >= 12 and hermi.whoring <= 14:
        $ hermione_chibi_xpos = 610
        show screen hermione_01_f 
        pause.3
        $ herViewHead.showQ( "body_120.png", posHead )
        her "(Не могу поверить, что я делала это сегодня...)"
    ...
    if hermi.whoring >= 15 and one_out_of_three == 1:
        $ hermione_chibi_xpos = 610
        show screen hermione_01_f 
        pause.3
