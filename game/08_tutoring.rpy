label tutoring:
    ...
    if knowledge == 0:
        ...
        g9 "{size=-4}(Кроме того, я собираюсь залезть к тебе в трусики, когда мы закончим.Ух паризан){/size}"
        $ herView.hideQQ()
        ...
        $ herView.hideQQ()
        $ herView.showQQ( "body_06.png", pos )
        her "Давайте приступим, Профессор?"
    ...
    elif knowledge >= 10 and tutoring_events == 1 and hermi.whoring >= 2:
        $ tutoring_events += 1
        "Event 02"

    elif knowledge >= 15 and tutoring_events == 2 and hermi.whoring >= 3:
        $ tutoring_events += 1
        "Event 03"

    elif knowledge >= 20 and tutoring_events == 3 and hermi.whoring >= 4:
        $ tutoring_events += 1
        "Event 04"

    elif knowledge >= 25 and tutoring_events == 4 and hermi.whoring >= 5:
        $ tutoring_events += 1
        "Event 05"

    elif knowledge >= 30 and tutoring_events == 5 and hermi.whoring >= 7:
        $ tutoring_events += 1
        "Event 06"

    elif knowledge >= 35 and tutoring_events == 6 and hermi.whoring >= 8:
        $ tutoring_events += 1
        "Event 07"

    if knowledge >= 40 and tutoring_events == 7 and hermi.whoring >= 9:
        $ tutoring_events += 1
        "Event 08"

    elif knowledge >= 45 and tutoring_events == 8 and hermi.whoring >= 11:
        $ tutoring_events += 1
        "Event 09"

    elif knowledge >= 50 and tutoring_events == 9 and hermi.whoring >= 13:
        $ tutoring_events += 1
        "Event 10"

    elif knowledge >= 55 and tutoring_events == 10 and hermi.whoring >= 14:
        $ tutoring_events += 1
        "Event 11"

    elif knowledge >= 60 and tutoring_events == 11 and hermi.whoring >= 16:
        $ tutoring_events += 1
        "Event 12"

    elif knowledge >= 65 and tutoring_events == 12 and hermi.whoring >= 18:
        $ tutoring_events += 1
        "Event 13"

    elif knowledge >= 70 and tutoring_events == 13 and hermi.whoring >= 20:
        $ tutoring_events += 1
        "Event 14"

    elif knowledge >= 75 and tutoring_events == 14 and hermi.whoring >= 21:
        $ tutoring_events += 1
        "Event 15"
