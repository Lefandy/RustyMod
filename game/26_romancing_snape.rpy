label date_with_snape_01:
    ...
    hide screen notes
    show screen notes
    ">Вы чувствуете тонкую связь между вами...у партизейн..."
    call sly_plus
    hide screen blktone
    hide screen bld1
    with d3
...
label date_with_snape_13:
    ...
    $ s_sprite = "03_hp/10_snape_main/snape_25.png"
    show screen s_head2                                                                                                 
    sna2 "Я на самом деле доволен ходом своей жизни."
    $ s_sprite = "03_hp/10_snape_main/snape_26.png"
    show screen s_head2                                                                                                 
    sna "И это беспокоит..."
    hide screen s_head2
...
label date_with_snape_15:
    ...
    show screen blktone
    with d3
    ">Уровень вашей дружбы с профессором Снейпом преодолел границы вселенной."
    ">Поздравляем! Вы стали для Северуса Снейпа лучшим другом."
