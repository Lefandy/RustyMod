...
label newsp_letter:
    ...
    if (hermi._incomePercent>0):
        ...
        $ gold-=nsp_newspaper_cur_money
        show screen points
        "> Согласно вашему соглашению с Гермионой [nsp_newspaper_cur_money] галеонов ([hermi._incomePercent]%%) перечисляются на ее счет"
...
label nsp_newsp_themes:
    ...
    $ nsp_germiona_statimg_rights = "Block"
    $ nsp_germiona_statimg_magls = "Block"
    $ nsp_germiona_statimg_kviddich = "Block"
    $ nsp_germiona_statimg_sex = "Block"
    $ nsp_germiona_statimg_maniac = "Block"
    $ nsp_germiona_statimg_nude = "Block"
    $ nsp_germiona_statimg_forest = "Block"
    $ nsp_germiona_statimg_studio = "Block"
...
label nsp_bonus_calc:
    ...
    if nsp_genie_photocamera == 0 or nsp_genie_sphere_req == "dis":
        ...
        $ nsp_newspaper_bonus_text = tr("  Развратная статья\n  ") + str (nsp_newspaper_bonus_text_base)
    ...
    if not nsp_genie_sphere_video:
        if nsp_genie_photocamera == 1:
            $ nsp_newspaper_bonus_text = tr("  Развратная статья\n  ") + str (nsp_newspaper_bonus_text_base) + tr("\n   с ч/б фото")
            $ nsp_photo_koef = 2
...
label nsp_bonus_calc_photo:
    ...
    if nsp_genie_photocamera == 1:
        $ nsp_newspaper_bonus_text = tr("  Ч/б развратные фото\n   Гермионы")
        $ nsp_photo_koef = 2
    elif nsp_genie_photocamera == 2:
        $ nsp_newspaper_bonus_text = tr("  Цв развратные фото\n   Гермионы")
        $ nsp_photo_koef = 4
    elif nsp_genie_photocamera == 3:
        $ nsp_newspaper_bonus_text = tr("  Развратные 3д-фото\n   Гермионы")
        $ nsp_photo_koef = 6
    elif nsp_genie_photocamera == 4:
        $ nsp_newspaper_bonus_text = tr("  Живые развратные фото\n   Гермионы")
        $ nsp_photo_koef = 10
...
label nsp_bonus_calc_video:
    ...
    if nsp_genie_sphere_ruby_level_eff == 0:
        ...
        $ nsp_newspaper_bonus_text = tr("  30 сек развратного видео\n   Гермионы")
        $ nsp_ruby_koef = 15
    elif nsp_genie_sphere_ruby_level_eff == 2:
        $ nsp_newspaper_bonus_text = tr("  1 мин развратного видео\n   Гермионы")
        $ nsp_ruby_koef = 25
    elif nsp_genie_sphere_ruby_level_eff == 3:
        $ nsp_newspaper_bonus_text = tr("  2 мин развратного видео\n   Гермионы")
        $ nsp_ruby_koef = 35
    elif nsp_genie_sphere_ruby_level_eff == 4:
        $ nsp_newspaper_bonus_text = tr("  5 мин развратного видео\n   Гермионы")
        $ nsp_ruby_koef = 55
    elif nsp_genie_sphere_ruby_level_eff == 5:
        $ nsp_newspaper_bonus_text = tr("  10 мин развратного видео\n   Гермионы")
        $ nsp_ruby_koef = 80
