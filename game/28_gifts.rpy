...
label giving_xxxsmallskirt:
    ...
    m "Не стоит благодарности.Благодари партизанов..."
    her "Я вас немного не понимаю профессор."
    m "В такие моменты я сам себя не понимаю..."
    her "..."
    $ herView.hideQQ()
...
label mini_on:
    $ pos = POS_370
    if hermi.whoring >= 0 and hermi.whoring <= 5:
    ...
    if hermi.whoring >= 6 and hermi.whoring <= 11:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        $ herView.hideshowQQ( "body_15.png", pos )
        her "Хм...?"
        $ herView.hideshowQQ( "body_17.png", pos )
        her "Но она очень короткая..."
...
label giving_lubricant:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/09.png"
        show screen gift
        with d3
...
label giving_condoms:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/10.png"
        show screen gift
        with d3
    ...
    if hero._perfumeused!=time.stamp:
        ...
        menu:
            "\"Возьми эти духи в подарок\"":
                ...
                $ hermi.IncValue("liking",9-hermi.whoring//3)
                call happy
...
label giving_candy:
    ...
    if hermi.whoring >= 0 and hermi.whoring <= 5:
        ...
        her "Конфета?"
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/11.png"
        show screen gift
        with d3
...
label giving_chocolate:
    ...
    if hermi.whoring >= 0 and hermi.whoring <= 5:
        ...
        her "Плитка шоколада?"
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/12.png"
        show screen gift
        with d3
...
label giving_vibrator:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        her "Но, тем не менее..."
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/13.png"
        show screen gift
        with d3
...
label giving_strapon:
    ...
    if hermi.whoring >= 0 and hermi.whoring <= 5:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/14.png"
        show screen gift
        with d3
...
label giving_ballgag:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/15.png"
        show screen gift
        with d3
...
label giving_plug:
    ...
    if hermi.whoring >= 0 and hermi.whoring <= 5:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/16.png"
        show screen gift
        with d3
...
label giving_mag1:
    ...
    if hermi.whoring >= 0 and hermi.whoring <= 5:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/17.png"
        show screen gift
        with d3
...
label giving_mag2:
    ...
    if hermi.whoring >= 6 and hermi.whoring <= 11:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/18.png"
        show screen gift
        with d3
...
label giving_mag3:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/19.png"
        show screen gift
        with d3
...
label giving_mag4:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        her "Но я возьму..."
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/20.png"
        show screen gift
        with d3
...
label giving_beer:
    ...
    if hermi.whoring >= 0 and hermi.whoring <= 5:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/21.png"
        show screen gift
        with d3
...
label giving_owl:
    ...
    if hermi.whoring >= 0 and hermi.whoring <= 5:
        ...
        her "Так мило..."
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/22.png"
        show screen gift
        with d3
...
label giving_sexdoll:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/23.png"
        show screen gift
        with d3
...
label giving_lingerie:
    ...
    if hermi.whoring >= 12 and hermi.whoring <= 17:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/24.png"
        show screen gift
        with d3
...
label giving_krum:
    ...
    if hermi.whoring >= 6 and hermi.whoring <= 11:
        ...
        $ herView.hideQQ()
        $ the_gift = "03_hp/18_store/26.png"
        show screen gift
        with d3
...
label giving_badge:
    ...
    her "Значок?"
    $ herView.hideQQ()
    $ the_gift = "03_hp/18_store/29.png"
    show screen gift
    with d3
...
label giving_nets:
    ...
    her "Пара чулков?"
    $ herView.hideQQ()
    $ the_gift = "03_hp/18_store/30.png"
    show screen gift
    with d3
...
label wrd_xxxsmallskirt_first_dress:
    ...
    if hermi.whoring >= 18 and hermi.whoring <= 23:
        $ herView.hideshowQQ( "body_04.png", pos )
        her "Вы же не всерьез, сэр?!"
...
label wrd_skimpyshirt_first_dress:
    ...
    if hermi.whoring >= 21 and hermi.whoring <= 23:
        $ herView.hideshowQQ( "body_15.png", pos )
...
label wrd_shirt_cheerleader_first_dress:
    ...
    $ pos = POS_370
    if hermi.whoring >= 0 and hermi.whoring <= 17:
        $ herView.hideshowQQ( "body_04.png", pos )
        her "Вы же не всерьез, сэр?!"
