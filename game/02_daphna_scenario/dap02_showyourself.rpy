...
label dap_request_02_complete:
    ...
    if IsRunNumber(1):
        ...
        $ hero("Пожалуй, с формой мы разобрались, больше в ней ходить не обязательно.")
        ...
        $ daphne(".....Не постеснялась бы, сэр?//~73 c0 1 pri// ........................//~37 00 2 ope// Дуумаю я могла бы снять блузку....//~37 00 2 neu// Дайте мне минуту...")
                ...
                menu:
                    ...
                    "\"Попросить её, показать сиcьки.\"":
                        ...
                        if daphne.whoring <= 8:
                            ...
                            $ daphne("~26 02 3 ang// Кажется мне лучше уйти...")
                            $ daphne.liking -= 7
                        else:
                            ...
                            $ screens.Show(Dissolve(1), "blkfade")
                            $ daphne.ItemsCustomize(update={"combi:default_up"})
