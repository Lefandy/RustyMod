label your_whore:
    ...
    if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        mal2 "И потом, чтоб ты знала, она не всегда берет деньги."
        ...
        mal2 "А если ты мне откажешь, я с горя просто все прогуляю."
        mal2 "Вот деньги..."
    ...
    if end.IsEnding(const_ENDING_PUBLIC_WHORE):
        ...
        fem "Я не зарабатываю себе популярность, позволяя кому-то засовывать член мне в рот!"
    ...
    if end.IsEnding(const_ENDING_YOUR_WHORE):
        ...
        fem "(Стала шлюхой за очки, имеешь в виду?!)"
        fem "(Какой позор!)"
        mal "(Это лишь слухи!)"
        fem "(Я думаю, что это больше, чем просто...)"
        mal "(Да заткнись уже. Ты просто ревнуешь!)"
        mal2 "(Да! Ты просто хочешь быть на месте Гермионы! Да, ты просто мечтаешь стать такой же, как она!)"
    ...
    her "Конечно, сэр."
    $ herViewHead.showQ( "body_167.png", posHead )
    her "Засуньте ваш член мне в рот и говорите со мной."
    ...
    $ end_u_1_pic =  "03_hp/17_ending/03.png"
    hide screen blkfade
    hide screen bld1
    with d7
    show screen ctc
    ...
    her "*Чавк!* *Глоть!* *Чавк!*"
    her "*Чавк--"
    $ end_u_2_pic =  "03_hp/17_ending/04.png"
    show screen end_u_2                                             
    with d7
    ...
    show screen end_u_2                                             
    with d7
    her "Коронация Королевы бала Хогвартса, сэр."
    m "Ох... Вот оно что?"
    m "Есть шанс, что ею станешь ты?"
    her "Шанс?"
    her "Все уже договорено, сэр."
    m "Что?"
    her "Ой, я хочу сказать - надеюсь, что стану..."
    ...
    $ end_u_1_pic =  "03_hp/17_ending/07.png"
    show screen end_u_1                                             
    with d7
    her "*Чавк!* *Чавк!* *Чавк!*"
    $ end_u_2_pic =  "03_hp/17_ending/04.png"
    ...
    m "Ммм..."
    her "Разве вы не согласны, сэр?!"
    $ end_u_1_pic =  "03_hp/17_ending/06.png"
    show screen end_u_1                                             
    with d7
    with hpunch
    ...
    if end.IsEnding(const_ENDING_PUBLIC_WHORE) or end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        her "*Чавк!* *Глоть!* *Чавк!*"
        m "Да..."
        $ end_u_2_pic =  "03_hp/17_ending/08.png"
        show screen end_u_2                                           
        with d7
        her "*Глоть!* *Чавк!* *Глоть!*"
        her "*Чавк*"
        $ end_u_1_pic =  "03_hp/17_ending/91.png"
        show screen end_u_1                                           
        with d7
        her "Сэр, вы думаете, что это правильно - угощать ЭТИМ Вашу юную студентку?"
        m "Ха!"
        $ end_u_2_pic =  "03_hp/17_ending/08.png"
        show screen end_u_2                                           
        with d7
        ...
        $ end_u_2_pic =  "03_hp/17_ending/92.png"
        show screen end_u_2                                           
        with d7
        her "А затем....................."
        $ end_u_1_pic =  "03_hp/17_ending/07.png"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/96.png"
        show screen end_u_1                                           
        with d7
        ...
        her "*Чавк!* *Чавк!* *Чавк!*"
        m "Ох..."
        $ end_u_2_pic =  "03_hp/17_ending/97.png"
        show screen end_u_2                                           
        with d7
        her "*Чавк!* *Глоть!* *Чавк!* *Чавк!* *Чавк!*"
        her "*Чавк!*"
        $ end_u_1_pic =  "03_hp/17_ending/98.png"
        show screen end_u_1                                           
        with d7
        ...
        with d7
        her "*Чавк*!"
        $ end_u_2_pic =  "03_hp/17_ending/91.png"
        show screen end_u_2                                           
        with d7
        ...
        with d7
        her "Хорошо..."
        $ end_u_2_pic =  "03_hp/17_ending/99.png"
        show screen end_u_2                                           
        with d7
        her "Мои мамочка и папочка будут гордиться мной!"
        $ end_u_1_pic =  "03_hp/17_ending/95.png"
        show screen end_u_1                                           
        with d7
        her "*Чавк!* *Чавк!* *Глоть!*"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/100.png"
        show screen end_u_1                                           
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/101.png"
        show screen end_u_1                                           
        with d7
        her "*Чавк!*.........................."
        her "!!!"
        ...
        show screen blkfade
        with d7
        $ end_u_2_pic =  "03_hp/17_ending/102.png"
        show screen end_u_2                                           
        ...
        $ end_u_1_pic =  "03_hp/17_ending/103.png"
        show screen end_u_1                                           
        with d7
        her "{size=+5}Кончайте на меня, сэр! Я хочу вашу горячую сперму!{/size}"
        g4 "Аргх! Ты, шлюха!.."
        $ end_u_2_pic =  "03_hp/17_ending/104.png"
        show screen end_u_2                                           
        with d7
        her "{size=+5}Да!{/size}"
        ...
        with hpunch
        g4 "{size=+7}АРГХ!{/size}"
        $ end_u_1_pic =  "03_hp/17_ending/105.png"
        show screen end_u_1                                           
        with d7
        ...
        $ end_u_2_pic =  "03_hp/17_ending/106.png"
        show screen end_u_2                                           
        with d7
        her "Ах... да... ах..."
        g4 "О... гх... *задыхается*"
        ...
        with d7
        her "Спасибо вам, сэр..."
        $ end_u_2_pic =  "03_hp/17_ending/107.png"
        show screen end_u_2                                           
        with d7
        her "..........................................."
        show screen ctc
        ...
        $ herViewHead.hideQ()
        m "И полная спермы прическа тебе поможет?"
        $ herViewHead.showQ( "body_165.png", posHead )
        her "Ну... да..."
        $ herViewHead.showQ( "body_163.png", posHead )
        ...
        $ end_u_2_pic =  "03_hp/17_ending/10.png"
        show screen end_u_2                                             
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/11.png"
        show screen end_u_1                                             
        with d7
        her "???................"
        ...
        show screen white
        pause.3
        $ end_u_1_pic =  "03_hp/17_ending/12.png"
        show screen end_u_1                                            
        ...
        $ end_u_2_pic =  "03_hp/17_ending/13.png"
        show screen end_u_2                                             
        with d7
        her "*Глотает-Глотает-Глотает!*"
        m "Да, сучка! Да!"
        ...
        show screen white
        pause.3
        $ end_u_2_pic =  "03_hp/17_ending/14.png"
        show screen end_u_2                                            
        hide screen white
        with vpunch
        show screen ctc
        ...
        $ end_u_1_pic =  "03_hp/17_ending/15.png"
        show screen end_u_1                                             
        with d7
        her "*Глотает-Глотает-Глотает!*"
        m "Да. Отличная шлюха."
        ...
        $ end_u_2_pic =  "03_hp/17_ending/16.png"
        show screen end_u_2                                             
        with d7
        ...
        $ renpy.play('sounds/spit.mp3')
        pause.3
        $ end_u_2_pic =  "03_hp/17_ending/17.png"
        show screen end_u_2                                            
        with vpunch
        show screen ctc
        pause
        ...
        her "..........................."
        her ".................."
        $ end_u_2_pic =  "03_hp/17_ending/18.png"
        show screen end_u_2                                             
        with d7
        her "*Глотает!* *Глотает!* *Лижет...* *Глотает!*"
        m "Ты выглядишь довольной с обкончанным лицом."
        $ end_u_1_pic =  "03_hp/17_ending/19.png"
        show screen end_u_1                                             
        with d7
        her "*Глотает!* *Глотает!* *Лижет...* *Глотает!*"
        m "Хм..."
        ...
        m "Должен ли я позвать твоих одноклассников?"
        $ end_u_2_pic =  "03_hp/17_ending/17.png"
        show screen end_u_2                                            
        with d7
        her "!!!!!!!!!!!!!!!"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/20.png"
        show screen end_u_2                                            
        with d7
        her "*Глотает??*"
        m "Я хочу, чтобы ты оставалась здесь еще немного."
        her "???"
        $ end_u_1_pic =  "03_hp/17_ending/21.png"
        show screen end_u_1                                           
        with d7
        m "Да, именно так."
        her "................"

        $ end_u_2_pic =  "03_hp/17_ending/22.png"
        show screen end_u_2                                           
        with d7
        her "....................................."
        ...
        her "..........."
        $ end_u_1_pic =  "03_hp/17_ending/23.png"
        show screen end_u_1                                           
        with d7
        ...
        her "...................."
        her "......."
        $ end_u_2_pic =  "03_hp/17_ending/24.png"
        show screen end_u_2                                          
        with d7
        with hpunch
        her "!!!"
        ...
        with hpunch
        her "{size=+7}!!!!!!!!!!!!!!!!{/size}"
        m "Перестань сопротивляться, шлюха! Ты никуда не пойдешь!"
        with hpunch
        her "{size=+9}!!!!!!!!!!!!!!!!{/size}"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/26.png"
        show screen end_u_1                                         
        with d7
        her "{size=+7}!!!!!!!!!!!!!!!!{/size}"
        m "Оу, ты посинела, любимая."
        m "Ты в порядке?"
        $ end_u_1_pic =  "03_hp/17_ending/27.png"
        show screen end_u_1                                         
        with d7
        her "{size=+9}!!!!!!!!!!!!!!!!........................{/size}"
        m "Смотри, сука!"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/28.png"
        show screen end_u_2                                        
        with d7
        her "{size=+9}??!.....................{/size}"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/29.png"
        show screen end_u_1                                        

        with vpunch
        her "{size=+9}*!!!!!!!!!!!!!!!!!!*{/size}"

        $ end_u_2_pic =  "03_hp/17_ending/30.png"
        show screen end_u_2                                        
        with d7
        her "...................................................................................."
        g4 "Вот это неплохо. Неплохой взгляд."
        $ end_u_1_pic =  "03_hp/17_ending/31.png"
        show screen end_u_1                                        
        with d7
        her "...........................................................*ГЛОТЬ!*"
        with hpunch
        ...
        $ end_u_2_pic =  "03_hp/17_ending/32.png"
        show screen end_u_2                                             
        with d7
        g4 "Но, все что ты получишь от меня, это порция горячей спермы!"
        $ end_u_1_pic =  "03_hp/17_ending/33.png"
        show screen end_u_1                                             
        with d7
        with hpunch
        her "{size=+9}ГХР!!!!!!!!!!!!!!!!{/size}"
        ...
        g4 "{size=+9}АРГХ!{/size}"
        with hpunch
        $ end_u_2_pic =  "03_hp/17_ending/34.png"
        show screen end_u_2                                             
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/35.png"
        show screen end_u_1                                             
        with d7
        her "{size=-4}*Глоть!* *Глоть!* *Глоть...*{/size}"
        m "О, да..."
        $ end_u_2_pic =  "03_hp/17_ending/36.png"
        show screen end_u_2                                             
        with d7
        her "...................................................."
    ...
    if end.IsEnding(const_ENDING_PUBLIC_WHORE) or end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        sna2 "Наконец-то Вы решили явиться?"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/108.png"
        hide screen blkfade
        with d7
        ...
        her "..............."
        her ".................................."
        $ end_u_2_pic =  "03_hp/17_ending/109.png"
        show screen end_u_2                                             
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/110.png"
        show screen end_u_1                                             
        with d7
        ...
        hide screen bld1
        with d3
        $ end_u_2_pic =  "03_hp/17_ending/113.png"
        show screen end_u_2                                             
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/114.png"
        show screen end_u_1                                             
        with d7
        ...
        hide screen bld1
        with d3
        $ end_u_2_pic =  "03_hp/17_ending/115.png"
        show screen end_u_2                                             
        with d7
        ...
        hide screen ctc
        $ end_u_1_pic =  "03_hp/17_ending/116.png"
        show screen end_u_1                                             
        with d7
        show screen ctc
        pause
        ...
        $ end_u_2_pic =  "03_hp/17_ending/117.png"
        show screen end_u_2                                             
        with d7
        her "Позвольте мне повториться..."
        $ end_u_1_pic =  "03_hp/17_ending/118.png"
        show screen end_u_1                                             
        with d7
        ...
        her "Они помогли мне..."
        her "Мама... Папа..."
        $ end_u_2_pic =  "03_hp/17_ending/119.png"
        show screen end_u_2                                             
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/120.png"
        show screen end_u_1                                             
        with d7
        her "..............................."
        her ".................."
        ...
        mal "(Думаешь, она знает, что её дойки видны всем?)"
        fem "(Стыдно-то как...)"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/121.png"
        show screen end_u_2                                             
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/122.png"
        show screen end_u_1                                             
        with d7
        her "Ох... точно..."
        her "Чуть не забыла..."
        $ end_u_2_pic =  "03_hp/17_ending/123.png"
        show screen end_u_2                                             
        with d7
        her "{size=+5}Вперед, Гриффиндор!{/size}"
        $ renpy.play('sounds/applause01.ogg')
        "*Дикий свист, вопли и аплодисменты*"
        $ end_u_1_pic =  "03_hp/17_ending/120.png"
        show screen end_u_1                                             
        with d7
        her "......................................"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/122.png"
        show screen end_u_2                                             
        with d7
        her "\"Выметаться\", сэр?"
        $ end_u_1_pic =  "03_hp/17_ending/119.png"
        show screen end_u_1                                             
        with d7
        her "Ох? Что это? Не может быть... одна из моих малышек выпала из платья..."
        $ end_u_2_pic =  "03_hp/17_ending/120.png"
        show screen end_u_2                                             
        with d7
        her "Как неловко..."
        $ end_u_1_pic =  "03_hp/17_ending/121.png"
        show screen end_u_1                                             
        with d7
        ...
        $ s_sprite = "03_hp/10_snape_main/snape_18.png"
        show screen s_head2
        sna "Мне это неинтересно! Идите уже отсюда!"
        sna "Сейчас же!"
        hide screen s_head2
        pause.1
        hide screen bld1
        ...
        $ end_u_2_pic =  "03_hp/17_ending/02.png"
        show screen end_u_2                                             
        with d7
        ...
        if end.IsEnding(const_ENDING_STRONG_GIRL):
            ...
            $ herViewHead.hideQ()
            g4 "Ну, сука!"
            her2 "Мне еще чем-то вас отблагодарить?"
        else:
        ...
        $ end_u_1_pic =  "03_hp/17_ending/46.png"
        show screen end_u_1                                             
        with d2
        hide screen blkfade
        hide screen bld1
        ...
        $ end_u_2_pic =  "03_hp/17_ending/50.png"
        show screen end_u_2                                             
        with d7
        if end.IsEnding(const_ENDING_STRONG_GIRL):
            ...
            her "Мне кажется, все прошло неплохо... Вам не понравилось?"
        g4 "Имеешь в виду твои сиськи, на которые мог глазеть каждый?!"
        $ end_u_1_pic =  "03_hp/17_ending/56.png"
        show screen end_u_1                                             
        with d2
        ...
        $ end_u_2_pic =  "03_hp/17_ending/59.png"
        show screen end_u_2                                             
        with d7
        her "Вы выебали её из меня, сэр!"
        g4 "Ты чертовски права, детка!"
        $ end_u_1_pic =  "03_hp/17_ending/124.png"
        show screen end_u_1                                             
        with d2
        ...
        $ end_u_2_pic =  "03_hp/17_ending/58.png"
        show screen end_u_2                                             
        with d7
        her "Ах!!!"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/55.png"
        show screen end_u_1                                             
        with d5
        her "Ах! Профессор!"
        $ end_u_2_pic =  "03_hp/17_ending/124.png"
        show screen end_u_2                                               
        with d5
        ...
        $ end_u_1_pic =  "03_hp/17_ending/125.png"
        show screen end_u_1                                             
        with d5
        her "Ах! Может быть..."
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        m "Что?"
        $ end_u_1_pic =  "03_hp/17_ending/51.png"
        show screen end_u_1                                             
        with d5
        ...
        $ end_u_1_pic =  "03_hp/17_ending/64.png"
        show screen end_u_1                                             
        with d5

        her "ААААААХ! ДААААА!"
        her "ДА!!! ДАААААА! АХ!"
        $ end_u_2_pic =  "03_hp/17_ending/63.png"
        show screen end_u_2                                             
        with d5
        ...
        $ end_u_2_pic =  "03_hp/17_ending/127.png"
        show screen end_u_2                                             
        with d5
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        $ end_u_1_pic =  "03_hp/17_ending/126.png"
        show screen end_u_1                                             
        with d7
        show screen ctc
        pause
        ...
        m "Присоединяйтесь!"
        sly1 "Серьезно?"
        $ end_u_2_pic =  "03_hp/17_ending/128.png"
        show screen end_u_2                                             
        with d5
        her "ЧТО?!"
        m "Конечно."
        $ end_u_1_pic =  "03_hp/17_ending/129.png"
        show screen end_u_1                                             
        with d7
        if end.IsEnding(const_ENDING_STRONG_GIRL):
            ...
            $ end_u_2_pic =  "03_hp/17_ending/130.png"
            show screen end_u_2                                             
            with d5
        ...
        $ renpy.play('sounds/spit.mp3')
        show screen white
        $ end_u_2_pic =  "03_hp/17_ending/132.png"
        show screen end_u_2                                             
        pause.2
        hide screen white
        with hpunch
        ...
        $ end_u_1_pic =  "03_hp/17_ending/133.png"
        show screen end_u_1                                             
        with d5
        her "!!!"
        m "Ну, начали!"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/134.png"
        show screen end_u_2                                             
        with d5
        her "Вы... Вы...!"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/135.png"
        show screen end_u_1                                             
        with d5
        ...
        with hpunch
        pause.3
        $ end_u_2_pic =  "03_hp/17_ending/133.png"
        show screen end_u_2                                             
        with d5
        her "Аах-ха!!!"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/136.png"
        show screen end_u_1                                             
        with d5
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        $ end_u_2_pic =  "03_hp/17_ending/137.png"
        show screen end_u_2                                             
        with d5
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        with hpunch
        pause.3
        $ end_u_1_pic =  "03_hp/17_ending/138.png"
        show screen end_u_1                                             
        with d5
        her "Ах... Аха..."
        ...
        $ renpy.play('sounds/spit.mp3')
        show screen white
        $ end_u_1_pic =  "03_hp/17_ending/139.png"
        show screen end_u_1                                             
        pause.2
        hide screen white
        with hpunch
        ...
        $ end_u_2_pic =  "03_hp/17_ending/140.png"
        show screen end_u_2                                             
        with d5
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        $ renpy.play('sounds/spit.mp3')
        show screen white
        $ end_u_2_pic =  "03_hp/17_ending/141.png"
        show screen end_u_2                                            
        pause.2
        hide screen white
        with hpunch
        ...
        $ end_u_1_pic =  "03_hp/17_ending/142.png"
        show screen end_u_1                                             
        with d5
        ...
        if end.IsEnding(const_ENDING_STRONG_GIRL):
            $ end_u_2_pic =  "03_hp/17_ending/142.png"
            show screen end_u_2                                             
        ...
        $ end_u_1_pic =  "03_hp/17_ending/143.png"
        show screen end_u_1                                                
        with hpunch
        ...
        m "Ну же!"
        $ end_u_2_pic =  "03_hp/17_ending/144.png"
        show screen end_u_2                                             
        with d5
        her "*Чавк...*"
        ...
        pause .1
        hide screen white
        $ end_u_1_pic =  "03_hp/17_ending/145.png"
        show screen end_u_1                                             
        with hpunch
        her "{size=+7}(*Глотает?!?*){/size}"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/146.png"
        show screen end_u_2                                             
        with d5
        ...
        her "{size=-5}*Глоть*..................{/size}"
        her "........................................"
        $ end_u_1_pic =  "03_hp/17_ending/147.png"
        show screen end_u_1                                             
        with d5
        her "Г-ха..."
        ...
        $ end_u_1_pic =  "03_hp/17_ending/148.png"
        show screen end_u_1                                             
        with hpunch
        ...
        $ end_u_2_pic =  "03_hp/17_ending/149.png"
        show screen end_u_2                                             
        with d5
        her "*Чавк!* *Чавк!* *Чавк!*"
        g4 "О... Да... Да!"
        ...
        pause .1
        hide screen white
        $ end_u_2_pic =  "03_hp/17_ending/150.png"
        show screen end_u_1                                             
        with hpunch
        her "{size=+7}*Глотает?!?*{/size}"
        $ end_u_1_pic =  "03_hp/17_ending/149.png"
        show screen end_u_1                                             
        with d5
        her "{size=+5}*Глоть-Глоть-Глоть-Глоть!*{/size}"
        her "{size=+3}*Глоть-Глоть...*{/size}"
        her "*Глоть...*"
        sly2 "Ах... мой член..."
        $ end_u_2_pic =  "03_hp/17_ending/152.png"
        show screen end_u_2                                             
        with d5
        her "Г-ха..."
        $ end_u_1_pic =  "03_hp/17_ending/151.png"
        show screen end_u_1                                             
        with d5
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        $ end_u_2_pic =  "03_hp/17_ending/154.png"
        show screen end_u_2                                             
        with d5
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        $ end_u_1_pic =  "03_hp/17_ending/153.png"
        show screen end_u_1                                             
        with d5
        if end.IsEnding(const_ENDING_STRONG_GIRL):
        ...
        $ end_u_1_pic =  "03_hp/17_ending/155.png"
        show screen end_u_1                                             
        with d5
        her "!!?"
        $ end_u_2_pic =  "03_hp/17_ending/156.png"
        show screen end_u_2                                             
        with d5
        her "*Чавк!* *Чавк!* *Чавк!*"
        ...
        $ end_u_1_pic =  "03_hp/17_ending/157.png"
        show screen end_u_1                                             
        with d5
        her "..............................................."
        m "Я так и думал!"
        ...
        pause .1
        hide screen white
        $ end_u_1_pic =  "03_hp/17_ending/159.png"
        show screen end_u_1                                             
        with hpunch
        her "{size=+7}*Глотает?!?*{/size}"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/160.png"
        show screen end_u_2                                             
        with d5
        ...
        her "........................................"
        her "....................."
        $ end_u_1_pic =  "03_hp/17_ending/154.png"
        show screen end_u_1                                             
        with d7
        her "Г-ха..."
        ...
        $ end_u_2_pic =  "03_hp/17_ending/161.png"
        show screen end_u_2                                             
        with d5
        ...
        pause .1
        hide screen white
        $ end_u_1_pic =  "03_hp/17_ending/162.png"
        show screen end_u_1                                             
        with hpunch
        ...
        pause .1
        hide screen white
        $ end_u_1_pic =  "03_hp/17_ending/163.png"
        show screen end_u_1                                             
        with hpunch
        ...
        pause .1
        hide screen white
        $ end_u_1_pic =  "03_hp/17_ending/164.png"
        show screen end_u_1                                             
        with hpunch
        ...
        $ end_u_2_pic =  "03_hp/17_ending/165.png"
        show screen end_u_2                                             
        with d7
        ...
        $ end_u_1_pic =  "03_hp/17_ending/166.png"
        show screen end_u_1                                             
        with d5
        ...
        pause .1
        hide screen white
        $ end_u_1_pic =  "03_hp/17_ending/167.png"
        show screen end_u_1                                             
        with hpunch
        ...
        her "{size=+8}AAAAAAAAAAAAХ!{/size}"
        $ end_u_2_pic =  "03_hp/17_ending/168.png"
        show screen end_u_2                                             
        with d5
        ...
        show screen white
        pause.3
        $ end_u_1_pic =  "03_hp/17_ending/169.png"
        show screen end_u_1                                            
        ...
        pause
        hide screen ctc
        $ end_u_2_pic =  "03_hp/17_ending/170.png"
        show screen end_u_2                                             
        with d5
        her "{size=+8}*Глоть!*{/size}"
        $ end_u_1_pic =  "03_hp/17_ending/168.png"
        show screen end_u_1                                            
        ...
        if end.IsEnding(const_ENDING_STRONG_GIRL):
            ...
            sly1 "Представь рожи гриффиндорцев, когда мы будем рассказывать, как драли их звезду, как последнюю прошмандов...."
        ...
        if end.IsEnding(const_ENDING_STRONG_GIRL):
            ...
            her2 "Так что, в худшем случае, вас могут привлечь за халатность."
            $ herViewHead.hideQ()
            ...
            $ herViewHead.showQ( "body_181.png", posHead )
            her2 "А вообще - да, у меня стало рвать крышу. Хотя, странно... После всего, что я вытворяла на сцене - меня провожали аплодисментами."
            $ herViewHead.showQ( "body_179.png", posHead )
        ...
        show screen blkfade
        if end.IsEnding(const_ENDING_STRONG_GIRL):
            $ end_u_2_pic =  "03_hp/17_ending/89.png"
        else:
            $ end_u_2_pic =  "03_hp/17_ending/90.png"
        show screen end_u_2                                             
        with d9
        pause.5
        hide screen blkfade
        ...
        $ end_u_2_pic =  "03_hp/17_ending/37.png"
        hide screen blkfade
        with d7
        ...
        her ".........................................................................."
        play music "music/11 Neville's Waltz.mp3" fadein 1 fadeout 1 
        $ end_u_1_pic =  "03_hp/17_ending/38.png"
        show screen end_u_1                                            
        with d3
        her "Ах-a.........................................."
        show screen bld1
        ...
        $ end_u_2_pic =  "03_hp/17_ending/39.png"
        show screen end_u_2                                            
        with d3
        her "...................................."
        her "Здравствуйте все..."
        $ end_u_1_pic =  "03_hp/17_ending/40.png"
        show screen end_u_1                                            
        with d3
        her "Спа*ибо, что соб*сь се*дня *десь..."
        show screen bld1
        with d5
        m "Я едва могу разобрать, что она там бормочет..."
        hide screen bld1
        with d5
        her "Фпервых, я хотелабы поблаборить Ппофессора Даблбора..."
        show screen bld1
        with d3
        m "Меня?"
        hide screen bld1
        ...
        pause
        hide screen ctc
        $ end_u_1_pic =  "03_hp/17_ending/41.png"
        show screen end_u_1                                            
        with d3
        $ renpy.play('sounds/gulp.mp3')
        her "{size=+5}*Глоть!!!*{/size}"
        $ end_u_2_pic =  "03_hp/17_ending/42.png"
        show screen end_u_2                                            
        with d3
        her "Гу-ха..."
        ...
        with d3
        play music "music/11 Neville's Waltz.mp3" fadein 1 fadeout 1 
        $ end_u_1_pic =  "03_hp/17_ending/43.png"
        show screen end_u_1                                            
        with d3
        ...
        $ end_u_2_pic =  "03_hp/17_ending/44.png"
        show screen end_u_2                                            
        with d3
        show screen bld1
        with d3
        ...
        fem "(Почему нет?)"
        fem "(Ведь каждый знает, что она трахается с Профессором Дамблдором!)"
        ...
        mal "(....)"
        fem "(Она просто помешана на сперме! Она, наверное, выпивает по стакану спермы в день...)"
        ...
        fem "(Неплохо получается?!)"
        fem "(Секундочку, ребята, что вы имеете в виду?)"
        mal "(Хех... Посмотри на ворона, вызывающего Черного Ворона!)"
        fem "(Что это значит?)"
        mal2 "(Ты сильно покраснела! И глаза словно затуманило!)"
        mal "(Да! Ты получаешь удовольствие от рассказа!)"
        fem "(!!!?)"
        fem "Вы идиоты!"
        $ renpy.play('sounds/run_03.mp3')
        pause 3
        ...
        $ end_u_1_pic =  "03_hp/17_ending/45.png"
        show screen end_u_1                                            
        with d3
        her "Это очень приятный и неожиданный сюрприз!.."
        her "И еще кое-что..."
        $ end_u_2_pic =  "03_hp/17_ending/43.png"
        show screen end_u_2                                            
        with d3
        her "{size=+5}Вперед, Гриффиндор!{/size}"
        show screen bld1
        with d5
        $ renpy.play('sounds/applause01.ogg')
        ">Толпа взрывается громкими аплодисментами и свистом..."
        hide screen bld1
        with d5
        show screen ctc
        pause
        ...
        m "Ну, прежде всего, я..."
        $ herViewHead.showQ( "body_163.png", posHead )
        her2 "Сэр, думаю, я знаю, что вы имеете в виду."
        $ herViewHead.hideQ()
        m "Ты знаешь?"
        $ herViewHead.showQ( "body_163.png", posHead )
        her "Конечно."
        ...
        $ end_u_2_pic =  "03_hp/17_ending/46.png"
        show screen end_u_2                                            
        with d3
        hide screen blkfade
        hide screen bld1
        ...
        m "Хм? твоя киска..."
        m "Она вся мокрая."
        $ end_u_1_pic =  "03_hp/17_ending/47.png"
        show screen end_u_1                                            
        with d5
        ...
        m "Это помогло тебе кончить?"
        $ end_u_2_pic =  "03_hp/17_ending/48.png"
        show screen end_u_2                                            
        with d5
        her "Немного..."
        ...
        $ end_u_1_pic =  "03_hp/17_ending/49.png"
        show screen end_u_1                                            
        with d5
        her "............."
        ...
        $ end_u_2_pic =  "03_hp/17_ending/51.png"
        show screen end_u_2                                            
        with d5
        ...
        $ end_u_2_pic =  "03_hp/17_ending/52.png"


        her "О-охх!"
        m "Заткнись, шлюха! Кто-нибудь услышит!"
        $ end_u_1_pic =  "03_hp/17_ending/53.png"
        show screen end_u_1                                            
        with d5
        her "Сэр, я..."
        ...
        hide screen white
        with hpunch
        $ end_u_1_pic =  "03_hp/17_ending/54.png"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/56.png"
        show screen end_u_2                                            
        with d5
        her ".............."
        ...
        hide screen white
        with hpunch
        $ end_u_2_pic =  "03_hp/17_ending/55.png"
        ...
        hide screen white
        with hpunch
        $ end_u_1_pic =  "03_hp/17_ending/58.png"
        ...
        hide screen white
        with hpunch
        $ end_u_1_pic =  "03_hp/17_ending/59.png"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/60.png"
        show screen end_u_2                                          
        with d5
        her "!!!"
        her "Танец! Я совсем забыла!!?"
        $ end_u_2_pic =  "03_hp/17_ending/61.png"
        show screen end_u_2                                          
        with d5
        ...
        g4 "Да... Это прекрасно, как никогда... О, да."
        $ end_u_1_pic =  "03_hp/17_ending/62.png"
        show screen end_u_1                                          
        with d5
        her "Сэр, вы меня слушаете вообще?"
        m "О, я все прекрасно слышу. И я делаю тебе встречное предложение."
        $ end_u_2_pic =  "03_hp/17_ending/61.png"
        show screen end_u_2                                          
        with d5
        her "Сэр?"
        ...
        $ end_u_2_pic =  "03_hp/17_ending/65.png"
        show screen end_u_2                                          
        with d5
        her "!!!............"
        g4 "Вот так, шлюшка. Веди себя тихо!"
        $ end_u_1_pic =  "03_hp/17_ending/66.png"
        show screen end_u_1                                          
        with d5
        her "Ах... Блах..."
        g4 "Твоя дырка... Чертовски узкая..."
        $ end_u_2_pic =  "03_hp/17_ending/67.png"
        show screen end_u_2                                          
        with d5
        her "Ах... блах... ах..."
        ...
        hide screen blktone
        with d5
        $ end_u_1_pic =  "03_hp/17_ending/69.png"
        show screen end_u_1                                            
        with fade
        play music "music/07 Introducing Colin2.mp3" fadein 1 fadeout 1 
        m "Не волнуйся, что пропустишь танец, шлюха."
        m "Мы станцуем наш собственный танец..."
        her "Ах..."
        m "Да. В этом году королева исполняет сложное \"па\" с членом глубоко в попке!"
        $ end_u_2_pic =  "03_hp/17_ending/69.png"
        show screen end_u_2                                            
        with d5
        her "Ах... я ахх..."
        m "Вы что-то хотите сказать, ваше величество?"
        her "Ах... Я королева бала... ах..."
        m "Конечно же, ты!"
        m "Но еще ты - шлюха!"
        $ end_u_1_pic =  "03_hp/17_ending/68.png"
        show screen end_u_1                                            
        with d5
        her "Я шлюха..."
        $ end_u_2_pic =  "03_hp/17_ending/70.png"
        show screen end_u_2                                           
        with d5
        her "{size=+7}Я шлюха!!!{/size}"
        $ end_u_1_pic =  "03_hp/17_ending/71.png"
        show screen end_u_1                                            
        with d5
        ...
        pause.3
        hide screen white
        $ end_u_1_pic =  "03_hp/17_ending/72.png"
        with hpunch
        ...
        hide screen white
        with hpunch
        $ end_u_2_pic =  "03_hp/17_ending/73.png"
        show screen end_u_2                                            
        with d5
        ...
        with hpunch
        g4 "Аргх! Мой член!"
        $ end_u_1_pic =  "03_hp/17_ending/74.png"
        show screen end_u_1                                            
        with d5
        ...
        $ end_u_1_pic =  "03_hp/17_ending/75.png"
        show screen end_u_1                                            
        with d5
        her "Хах?"
        ...
        with hpunch
        with kissiris
        $ end_u_1_pic =  "03_hp/17_ending/77.png"
        hide screen blkfade
        with d5
        ...
        g4 "Верно, сучка!"
        $ end_u_2_pic =  "03_hp/17_ending/79.png"
        show screen end_u_2                                            
        with d5
        her "Но я все еще кончаю!"
        her "Что со мной происходит, сэр!?"

        m "Все в порядке, я знаю, что делаю!"
        m "Это нормально для шлюшки."
        $ end_u_1_pic =  "03_hp/17_ending/78.png"
        show screen end_u_1                                            
        with d5
        ...
        $ end_u_2_pic =  "03_hp/17_ending/81.png"
        show screen end_u_2                                            
        with d5
        her "{size=+5}Ох!!!{/size}"
        her "{size=+5}Я шлюха!!!{/size}"
        ...
        menu:
            "- Кончить в киску Гермионы -":
                ...
                pause .1
                hide screen white
                $ end_u_2_pic =  "03_hp/17_ending/86.png"
                with hpunch
                ...
                g4 "Аргх! Да!"
                $ end_u_1_pic =  "03_hp/17_ending/87.png"
                show screen end_u_1                                         
                with d5
                ...
                $ end_u_2_pic =  "03_hp/17_ending/88.png"
                show screen end_u_2                                             
                with d5
                her "Профессор! Мое платье!"
                g4 "Что?"
                her "Постарайтесь не запачкать мое платье!"
            ...
            "- Кончить в задницу Гермионы -":
                ...
                with hpunch
                with kissiris
                $ end_u_1_pic =  "03_hp/17_ending/82.png"
                show screen end_u_1                                          
                with d5
                ...
                g4 "Да! Да!"
                $ end_u_2_pic =  "03_hp/17_ending/83.png"
                show screen end_u_2                                             
                with d5
                her "{size=+5}Оно внутри меня! Наполняет всю меня!!!{/size}"
                g4 "Да! ШЛЮХА! Я заполню тебя до краев своей спермой!"
                $ end_u_1_pic =  "03_hp/17_ending/84.png"
                show screen end_u_1                                             
                with d5
                ...
                g4 "Заткнись про платье, шлюха! Ты портишь весь момент!!"
                $ end_u_2_pic =  "03_hp/17_ending/85.png"
                show screen end_u_2                                             
                with d5
                her "{size=+5}Извините! Ваша шлюха просит прощения!!!!{/size}"
                g4 "Да! Так-то лучше!"
        ...
        if d_flag_01:
            show screen end_u_1                                             
            $ end_u_1_pic =  "03_hp/17_ending/89.png"
        else:
            show screen end_u_1                                             
            $ end_u_1_pic =  "03_hp/17_ending/90.png"
...
label test:
    ...
    $ end_u_1_pic =  "03_hp/17_ending/171.png"
    show screen end_u_1                                           
    pause.3
    hide screen blkfade
    with d7
    ...
    $ end_u_3_pic =  "03_hp/17_ending/172.png"
    show screen end_u_3                                           
    with d7
    ...
    $ end_u_4_pic =  "03_hp/17_ending/173.png"
    show screen end_u_4                                           
    with d7
    pause.5
    ...
    if pho_ending >= 1 and dap_ending >= 2:
        call dap_outro_3

    $ renpy.play('sounds/magic4.ogg')
    with hpunch
    $ end_u_3_pic =  "03_hp/17_ending/174.png"
    hide screen end_u_4                                           
    show screen end_u_3                                           
    with d7
    ...
    $ end_u_4_pic =  "03_hp/17_ending/175.png"
    show screen end_u_4                                           
    with d7
    ...
    if _preferences.language == "english":
        centered "{cps=20}{size=+5}{color=#ea91b0}-Witch Trainer 1.6f-{/color}{/size}\n\n {color=#e5e297}-{{Russian translation of the Witch Trainer:}-{/color}\n {color=#fff} Ave_Fletch, Nyarkohotep, Discordnk90, maniac4a,\n Rio-Violente, MrFrost1991, babaylolxz, Borzsama,\n sn0rk95, Khan, Skazochnik {/color}\n\n {color=#e5e297}-{{Coding:}-{/color}\n {color=#fff} Eskelsama, Dron {/color}\n\n {color=#e5e297}-{{Texts, Scenario:}-{/color}\n {color=#fff}Dron, Tobie, andie{/color}\n\n {color=#e5e297}-{{Technical support (Forum):}-{/color}\n {color=#fff}Khan, Appo{/color}\n\n {color=#e5e297}-{{English translation of the game:}-{/color}\n {color=#fff}PFMX{/color}\n\n {color=#e5e297}-{{Arts:}-{/color}\n {color=#fff}{a=http://scerg.daportfolio.com/}Scerg{/a}, Oh Zar, Zio, CaptainNemo, {a=http://gedeonandhiscoolchicks.blogspot.ru}Gedeon{/a}, {a=http://virink.com/GRENDIDG}Grendidg{/a}, {a=https://twitter.com/Ardaros}Ardaros{/a}, Dron{/color}\n\n {size=-5}{color=#e5e297}-{{Testers:}-{/color}\n {color=#fff} TenchiMuyo1984, GIZ61, Lexickon, 6pool{/color}{/size}\n\n {size=-5}{color=#e5e297}-{{???}-{/color}{/size}\n\n {size=-7}{color=#e5e297}-{{Following people were involved in early stages of development:}-{/color}\n {color=#fff} Dimon_Tools, illidan, darg55, Fuhrick, Zilot, Skazochnik, Nyarkohotep, Powergirl, andie {/color}{/size}\n\n Game was developed with the usage of ideas and art from Akabur and Dahr and Xaljio’s code."
    else:
        ...
        centered "{cps=20}{size=+5}{color=#ea91b0}-Тренер ведьмы (Witch Trainer) 1.6f-{/color}{/size}\n\n {color=#e5e297}-{{Перевод сюжета Witch Trainer на русский язык с оригинала:}-{/color}\n {color=#fff} Ave_Fletch, Nyarkohotep, Discordnk90, maniac4a,\n Rio-Violente, MrFrost1991, babaylolxz, Borzsama,\n sn0rk95, Khan, Skazochnik {/color}\n\n {color=#e5e297}-{{Программирование:}-{/color}\n {color=#fff} Eskelsama, Dron {/color}\n\n {color=#e5e297}-{{Тексты, сценарии:}-{/color}\n {color=#fff}Dron, Tobie, andie{/color}\n\n {color=#e5e297}-{{Техническая поддержка (форум):}-{/color}\n {color=#fff}Khan, Appo{/color}\n\n {color=#e5e297}-{{Перевод игры на английский язык:}-{/color}\n {color=#fff}PFMX{/color}\n\n {color=#e5e297}-{{Арты:}-{/color}\n {color=#fff}{a=http://scerg.daportfolio.com/}Scerg{/a}, Oh Zar, Zio, CaptainNemo, {a=http://gedeonandhiscoolchicks.blogspot.ru}Gedeon{/a}, {a=http://virink.com/GRENDIDG}Grendidg{/a}, {a=https://twitter.com/Ardaros}Ardaros{/a}, Dron{/color}\n\n {size=-5}{color=#e5e297}-{{Тестеры:}-{/color}\n {color=#fff} TenchiMuyo1984, GIZ61, Lexickon, 6pool{/color}{/size}\n\n {size=-5}{color=#e5e297}-{{???}-{/color}{/size}\n\n {size=-7}{color=#e5e297}-{{На ранних этапах игры участие в разработке также принимали:}-{/color}\n {color=#fff} Dimon_Tools, illidan, darg55, Fuhrick, Zilot, Skazochnik, Nyarkohotep, Powergirl, andie {/color}{/size}\n\n Игра разрабатывается с использованием идеи и артов Акабура и Дахра, и кода Xaljio."
    ...
    centered "{cps=20}{size=+4}{color=#ffc600}Special thanks to:{/color}{/size}\n {color=#fff} PFmaxkl.\n Lexickon\n Appo\n DoctorBooooom\n \n {color=#FF0000}A life member of the Board of Trustees{/color}\n {color=#fff} bugbear, andie, KAIN_GHoST, pavlin, Nesudba\n nik69, Severus Snape, Zatoy, larkesso, Ademeor\n Korvain, LEGENDARO, 6pool, Ancord, V_anabioze\n Azrailich, AndreiP\n \n {color=#e5e297}The Board of Trustees{/color}\n {color=#fff} AndreiP,AntonyK,Boolan,dagger,Eizekil,gildor,goodleses\n Happy_ua,Hensis,Jericholol,Lansi,Lonely Ghost,madhomer\n MegossFox2013Q,Polosatik305,Rabid,rouzenrot,Slutsak,sonia\n Stalinyasha,Syzarc,tard,Vicious,x49\n "
    ...
    centered "{cps=20} {color=#02e812}Elders{/color}\n {color=#fff} Abruzzo1609,Absenty,advo-cat,ajvar,Anemon,Anrei,appo,Arioch77\n artem1703,AstatA,Astes,Avrei,B-van,Benq666,CloverField,cviatoi\n D.Thorn,danf,Dart_Kot,Dekrust,demonikys99,Detamin,DTRZ,DukeDeer\n Dushman,Freeze,funabashi,Glazier,grastak,Grezli,Hihion,igor__dm\n ishu,jeb,Kapa225,Killalell,kinarii,Krimkrot,Lexickon,LexThorn,li na\n LION,Lola22,Makc,manitor1,Mushroom,Nasheed,Nezo,Nilarion,Pacifeest\n PFMX,Plotvaccio,poo,Rayko,Razor,Rivalune,Rusgus,Skaz,skramlrak\n Smartass,Solpin,strelochnik,Sudian,tartan,TenchiMuyo1984,TheEcho,\n tom_ridler,trevin,unikod,Velh,VirysMaster,Viskirson,Wetcrow\n Whit,whitepeledin,Zhivtone\n \n {color=#3c8fdc}Testers{/color}\n {color=#fff} GIZ61\n TenchiMuyo1984,6pool\n {/color}"
    ...
    if end.IsEnding(const_ENDING_PUBLIC_WHORE) or end.IsEnding(const_ENDING_STRONG_GIRL) or ( pho_ending >= 1 and dap_ending >= 2 ):
